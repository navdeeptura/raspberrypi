...
default_args = {
 ...
 'companyname': 'Otics',  # <<< ********** You change as needed
  ...
  'prediction_data_topic' : 'cisco-network-preprocess', # Separate multiple topics with comma <<< ********** You change topic names as needed
...
@dag(dag_id="tml_system_step_2_kafka_createtopic_dag_groupproject4dec-11f8", default_args=default_args, tags=["tml_system_step_2_kafka_createtopic_dag_groupproject4dec-11f8"], start_date=datetime(2023, 1, 1), schedule=None,catchup=False)
def startkafkasetup():
    def empty():
        pass
dag = startkafkasetup()
