...
default_args = {
 ...
 'pgptcontainername' : 'maadsdocker/tml-privategpt-no-gpu-amd64', #'maadsdocker/tml-privategpt-no-gpu-amd64',  maadsdocker/tml-privategpt-with-gpu-nvidia-amd64 # enter a valid container https://hub.docker.com/r/maadsdocker/tml-privategpt-no-gpu-amd64
...
@dag(dag_id="tml_system_step_9_privategpt_qdrant_dag_navdeepproject8nov-11f8", default_args=default_args, tags=["tml_system_step_9_privategpt_qdrant_dag_navdeepproject8nov-11f8"], schedule=None,  catchup=False)
def startaiprocess():
    # Define tasks
    def empty():
        pass
