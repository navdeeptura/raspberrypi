...
default_args = {
 ...
 'solutionname': 'navdeepproject8nov-11f8',   # <<< *** DO NOT MODIFY - THIS WILL BE AUTOMATICALLY UPDATED
...
@dag(dag_id="tml_system_step_1_getparams_dag_navdeepproject8nov-11f8", default_args=default_args, tags=["tml_system_step_1_getparams_dag_navdeepproject8nov-11f8"], schedule=None, catchup=False)
def tmlparams():
    # Define tasks
    def empty():
        pass
