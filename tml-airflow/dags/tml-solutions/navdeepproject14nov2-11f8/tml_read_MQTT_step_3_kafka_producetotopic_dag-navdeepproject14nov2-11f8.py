...
default_args = {
  ...
  'mqtt_broker' : 'f10fd264fefc4d72b3a1fffd529c94ed.s1.eu.hivemq.cloud', # <<<****** Enter MQTT broker i.e. test.mosquitto.org
...
@dag(dag_id="tml_mqtt_step_3_kafka_producetotopic_dag_navdeepproject14nov2-11f8", default_args=default_args, tags=["tml_mqtt_step_3_kafka_producetotopic_dag_navdeepproject14nov2-11f8"], schedule=None,catchup=False)
